...
This project manages Azure Management Groups using Terraform.
...
- Example: `resource "azurerm_management_group" "core"` not `resource "azurerm_management_group" "mg_core"`.
